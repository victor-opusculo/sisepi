...
De todo o sistema, o módulo de eventos é o maior e mais complexo, pois ele gerencia as listas de inscrições, as listas de presença e também permite ao aluno que cumpriu a carga horária requerida gerar seu próprio certificado. O segundo maior e mais complexo é da Biblioteca Legislativa, que mantém o cadastro do acervo de publicações, dos usuários, dos empréstimos de publicações e de reservas para empréstimo.
