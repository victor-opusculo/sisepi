...
<div class="viewDataFrame doubleColumnFrame">	
		...
		<label>Disponível para empréstimo? </label><?php echo $pubObj->isAvailable ? '<img src="' . URL\URLGenerator::generateBaseDirFileURL("pics/check.png") . '" alt="Sim"/>' : '<img src="' . URL\URLGenerator::generateBaseDirFileURL("pics/wrong.png") . '" alt="Não"/>'; ?><br/>
