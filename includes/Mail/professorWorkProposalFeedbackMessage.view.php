...
<p>Você enviou por nosso sistema a proposta "<?= $proposalName ?>" para trabalho de docente. Informamos que ela foi 
<span style="font-weight:bold; color:<?php echo $isApproved ? 'green;' : 'red;'; ?>"><?php echo $isApproved ? 'aprovada' : 'rejeitada'; ?></span>
