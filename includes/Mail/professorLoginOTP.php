...
function sendEmailProfessorOTP($oneTimePassword, $professorEmail, $professorName)
{
    ...
    $mail->Subject  = "SisEPI - Senha de acesso ao Painel de Docente"; // Assunto da mensagem

    ob_start();
    $__VIEW = 'professorLoginOTPMessage.view.php';
