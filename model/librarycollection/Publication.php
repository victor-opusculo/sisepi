...
class Publication extends DataEntity
{
    ...
    public function getSingle(mysqli $conn) : Publication
    {
		...
		return isset($dataRow) ? $this->newInstanceFromDataRow($dataRow) : throw new \Model\Exceptions\DatabaseEntityNotFound('Publicação não localizada!', $this->databaseTable);
    }
