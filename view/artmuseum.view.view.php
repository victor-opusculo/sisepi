...
<div class="artImageFrame">
	<img src="<?php echo $attachsPath . $artPieceObj->mainImageAttachmentFileName; ?>" alt="<?php echo hscq($artPieceObj->name); ?>" />
</div>
<?php } else { ?>
...
<div class="viewDataFrame">
	...
	<label>Número de patrimônio (CMI): </label><?php echo $artPieceObj->CMI_propertyNumber; ?> <br/>
	...
	<div class="editDeleteButtonsFrame">
		<ul>
			<li><a id="linkEdit" href="<?php echo URL\URLGenerator::generateSystemURL("artmuseum", "edit", $artPieceObj->id); ?>">Editar</a></li>
			<li><a id="linkDelete" href="<?php echo URL\URLGenerator::generateSystemURL("artmuseum", "delete", $artPieceObj->id); ?>">Excluir</a></li>
		</ul>
	</div>
</div>
<?php } ?>