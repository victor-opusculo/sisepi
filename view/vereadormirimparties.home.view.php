<div>
	...
	<span class="searchFormField">
		<?php if (URL\URLGenerator::$useFriendlyURL === false): ?>
			<input type="hidden" name="cont" value="vereadormirimparties"/>
		<?php endif; ?>
...
<label>Ordem de exibição: </label>
	...
	<a href="?<?php echo URL\QueryString::getQueryStringForHtmlExcept("orderBy") . URL\QueryString::formatNew("orderBy", "acronym"); ?>">Sigla</a>
</div>
<div>
	<a class="linkButton" href="<?php echo URL\URLGenerator::generateSystemURL("vereadormirimparties", "create"); ?>">Novo</a>
</div>
<?php
$dgComp->render();
