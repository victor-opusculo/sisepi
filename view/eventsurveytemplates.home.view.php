<div>
	...
	<span class="searchFormField">
		<?php if (URL\URLGenerator::$useFriendlyURL === false): ?>
			<input type="hidden" name="cont" value="eventsurveytemplates"/>
		<?php endif; ?>
...
<div>
	<a class="linkButton" href="<?php echo URL\URLGenerator::generateSystemURL("eventsurveytemplates", "create"); ?>">Novo</a>
</div>
