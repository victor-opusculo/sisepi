...
<form method="post" action="<?php echo URL\URLGenerator::generateFileURL("post/calendar.editdate.post.php", "cont=calendar&action=editdate&id=" . $calendarEventObj->id); ?>" >
    ...
    <span class="formField"><label>Marcar para o dia: <input type="date" name="calendardates:dateEventDate" required="required" value="<?php echo $calendarEventObj->date; ?>"/></label></span>
    <span class="formField">
        ...
        <label><input type="time" step="1" name="calendardates:timeEndTime" value="<?php echo $calendarEventObj->endTime; ?>"/></label> (opcional) </span>
    <span class="formField">
