...
<h4 style="text-align: center;">Comprovante de empréstimo de item do acervo da biblioteca</h4>
...
<div class="viewDataFrame">
	...
	<br/>
	<label>Comprovante emitido por: </label><?php echo $_SESSION["username"]; ?> <label>em</label> <?php echo date("d/m/Y H:i:s"); ?>
</div>
