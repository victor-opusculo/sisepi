<div>
	...
	<span class="searchFormField">
		<?php if (URL\URLGenerator::$useFriendlyURL === false): ?>
			...
			<input type="hidden" name="action" value="listcertificates"/>
		<?php endif; ?>
...
<label>Ordem de exibição: </label>
	...
	<a href="?<?php echo URL\QueryString::getQueryStringForHtmlExcept("orderBy") . URL\QueryString::formatNew("orderBy", "date"); ?>">Data de emissão</a>
</div>
<br/>
<?php
$dgComp->render();
...
<div class="rightControl">
    <a 
        class="linkButton"
        href="<?= URL\URLGenerator::generateFileURL('generate/allCertificatesToCsv.php', [ 'orderBy' => $_GET['orderBy'] ?? '', 'q' => $_GET['q'] ?? '' ] ) ?>">
        Exportar para CSV
    </a>
</div>